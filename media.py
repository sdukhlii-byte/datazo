...
# ── Moment → filename mapping ─────────────────────────────────────────────────
MOMENT_PICS = {
    "start":       "19.png",    # Focus Win Repeat — first impression
    "onboarding1": "110.png",   # Demon at keyboard — intense, focused
    "onboarding2": "111.png",   # Demon flying — momentum
    "bridge":      "113.png",   # Demon winning at PC — "I profit from this"
    "cta":         "114.png",   # Demon plotting — "here's how you do it"
    "ftd":         "112.png",   # VICTORY — celebration
    "morning":     "115.png",   # GAME ON — daily kickoff
    "picks":       "114.png",   # Demon focused — analysis mode
    "repeat_hot":  "116.png",   # Demon raging — urgency push
    "repeat_win":  "117.png",   # Crystal trophy — reward framing
}
...
async def send_pic(
    ...
    try:
        ...
        logger.error(f"send_pic failed for {filename}: {e}")
        # Fallback to text
        try:
            await bot.send_message(
                chat_id=chat_id,
