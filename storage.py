"""
storage.py — Datazo by Coinplay
JSON persistence with racing preferences for personalization.
"""
...
def _default(user_id: int, lang: str = "en") -> dict:
    return {
        ...
        "onboarding_turn": 0,
        "preferences": {
            "regions":    [],    # ["UK & Ireland", "LATAM", ...]
            "tracks":     [],    # ["Ascot", "San Isidro", ...]
            "bet_style":  None,  # "win" | "each_way" | "value" | "favourites" | "all"
            "experience": None,  # "new" | "casual" | "sharp"
        },
    }
